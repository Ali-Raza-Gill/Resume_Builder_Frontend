        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          ...
          <div>
            <Typography variant="h6" sx={{ marginTop: "8px", display: 'flex', gap: '4px', alignItems: 'center', paddingLeft: '10px' }}>
              <p style={{ display: 'flex', gap: 3, alignItems: 'center' }}>
                Skills
                <Tooltip
                  title={<Box sx={{ p: 1, fontSize: '0.9rem' }}>{"eg: Web development, Mobile development, DevOps,IT Specialist"}</Box>}
                  placement="top"
                  arrow
                >
                  <p style={{ fontSize: '1rem' }}> <i class="fa-solid fa-circle-info"></i></p>
          ...
          <div>
            <Typography variant="h6" sx={{ marginTop: "8px", display: 'flex', gap: '4px', alignItems: 'center', paddingLeft: '10px' }}>
              ...
              Tools & Technologies
                <Tooltip
                  title={<Box sx={{ p: 1, fontSize: '0.9rem' }}>{"eg: MS Office, Jira, Notion, Canva,Power BI, Figma, Adobe"}</Box>}
                  placement="top"
                  arrow
                >
                  <p style={{ fontSize: '1rem' }}> <i class="fa-solid fa-circle-info"></i></p>
              ...
              {extraDetails?.skills?.webFrameworks?.map((webFrame, index) => (
                <Grid item md={4} sm={6} xs={12} key={index} style={{ display: 'flex', gap: '4px' }} >
                  <TextField
                    ...
                    label={`Tools & Technologies ${index + 1}`}
                    style={{ width: "100%" }}
                    value={webFrame}
                    onChange={(e) =>
          ...
          <div>
            <Typography variant="h6" sx={{ marginTop: "8px", display: 'flex', gap: '4px', alignItems: 'center', paddingLeft: '10px' }}>
              ...
              Volunteer Work
                <Tooltip
                  title={<Box sx={{ p: 1, fontSize: '0.9rem' }}>{"eg: Community Tutor ,Event Organizer"}</Box>}
                  placement="top"
                  arrow
                >
                  <p style={{ fontSize: '1rem' }}> <i class="fa-solid fa-circle-info"></i></p>
